  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="img/D Rose_logo.png" alt="AdminLTE Logo" class="brand-image " style="opacity: .8">
        <span class="brand-text font-weight-light text-black">D E P O T</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            ...
            ?>
              <img width="44" class="img-circle avatar" src="../<?php echo $imgName; ?>">
          ...
          <div class="info">
            ...
            ?>
              ...
              <a href="profile.php" class="d-block"><?php echo $_SESSION["AdminName"]; ?></a>
            <?php
            }
            ?>
          </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            ?>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  ...
                  <p>
                    Admin Management <i class="fas fa-angle-left right"></i>
                  </p>
                </a>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="InteriorDesignerList.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="catagorylist.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Category</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="Custfeedback.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>On Own Product</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="Interiorfeedback.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>On Interior Work</p>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <!-- <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="CMSpage.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>CMS Page</p>
                  </a>
                </li>
