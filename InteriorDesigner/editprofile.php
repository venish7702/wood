                            ...
                            ?>
                                <form class="mt-5" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="txtName" value="<?php echo $res["first_name"], " ", $res["last_name"]; ?>" id="txtName">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Email Id</label>
                                        <div class="col-sm-8">
                                            <input type="email" class="form-control" name="txtEmail" value="<?php echo $res["email_id"]; ?>" readonly="redaonly">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Contact No</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="txtContact" maxlength="10" name="txtContact" value="<?php echo $res["contact_no"]; ?>" placeholder="Enter Contact No">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input type="text" name="hdnName" value="<?php echo $res["image_url"]; ?>">
                                        </div>
                                    </div>
