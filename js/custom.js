$(document).ready(function () {
    ...
    $('.mob_main_menu li .mega_div_mob').hide();

    $('.heder_shop').click(function () {
        $('.mega_div_mob').slideToggle();
...
$(document).on('click', '.isotop-btn-group .isotop-btn', function () {
    $(this).addClass('active').siblings().removeClass('active')
    // -----product gallery end-----------------------


})
// product color chang start-------------------------
